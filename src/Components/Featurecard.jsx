    ...
    <div className="rounded-2xl shadow-md overflow-hidden bg-white">
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center gap-1">
          {" "}
          <CiLocationOn className="text-red-900 font-semibold" />{" "}
          <p className="text-sm text-gray-600 poppins"> {location}</p>
        </div>
        <div className="flex items-center gap-1">
          <FaRegMoneyBillAlt />{" "}
          <p className="text-sm text-gray-600 poppins">Rent: ${rent}/month</p>
        </div>
        <div className="flex items-center gap-1">
          {" "}
          <MdBedroomChild />
          <p className="text-sm text-gray-600 poppins"> Room: {roomType}</p>
        </div>
        <div className="flex items-center gap-1">
          {" "}
          <MdEventAvailable />
