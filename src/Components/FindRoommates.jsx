      ...
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-xl p-8">
        ...
        >
          ...
          <div className="col-span-1 md:col-span-2">
            <label className="text-sm font-semibold text-gray-600 poppins">
              Title
            </label>
            <input
              name="title"
          ...
          <div>
            ...
            <input
              ...
              className="input input-bordered poppins w-full mt-1"
              required
            />
          </div>
          ...
          <div>
            ...
            <select
              name="roomType"
              className="select select-bordered w-full mt-1 poppins"
              required
            >
          ...
          <div>
            ...
            <input
              ...
              className="input input-bordered w-full poppins mt-1"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              value={user?.email || ""}
              name="email"
              className="input input-bordered w-full mt-1 bg-gray-100 poppins"
            />
          </div>
          ...
          <div className="col-span-1 md:col-span-2 text-center mt-4 ">
            <button
              type="submit"
              className="btn btn-primary btn-wide text-white text-lg poppins tracking-wide shadow-md hover:scale-105 duration-200"
            >
              <FaSearchPlus /> Add
            </button>
          </div>
